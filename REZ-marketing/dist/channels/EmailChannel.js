...
class EmailChannel {
     ...
     */
    buildHtml(message, campaignId, ctaUrl, ctaText) {
  ...
  <img src="${trackPixel}" width="1" height="1" style="display:none;" alt="">
    ...
    async send(options) {
        ...
        try {
            ...
            logger_1.logger.info('[Email] Sent', { campaignId: options.campaignId, messageId: info.messageId });
            return { success: true, messageId: info.messageId };
        }
        catch (err) {
            logger_1.logger.warn('[Email] Send failed', { campaignId: options.campaignId, err: err.message });
            return { success: false, error: err.message };
        }
    }
}
exports.emailChannel = new EmailChannel();
exports.default = exports.emailChannel;
